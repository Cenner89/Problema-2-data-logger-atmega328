...
cap = p(doc, "Fig. 1. Diagrama de blocos da arquitetura proposta para o sistema de monitoramento ambiental baseado no microcontrolador ATmega328P.", align=WD_ALIGN_PARAGRAPH.CENTER, size=8)
